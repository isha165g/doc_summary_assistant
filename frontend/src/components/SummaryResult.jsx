...
`;
  ...
  const handleDownloadPdf = () => {
    try {
      ...
      const metaText = `Type: ${formatDocumentType(result.document_type)}  |  Words Extracted: ${result.word_count?.toLocaleString() || 0}  |  Preset: ${result.length?.toUpperCase()}  |  Date: ${new Date().toLocaleDateString()}`;
      ...
      const baseName = (result.filename || 'summary').replace(/\.[^/.]+$/, "");
